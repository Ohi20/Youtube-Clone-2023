...
export const demoThumbnailUrl = 'http://img.youtube.com';
export const demoChannelUrl = 'https://youtu.be/a7V9bUwc4cU?t=1';
export const demoVideoUrl = '/video/GDa8kZLNhJ4';
export const demoChannelTitle = 'YouTube';
export const demoVideoTitle =
  'Build and Deploy JavaScript & React API Projects | RapidAPI';
